...
echo "  ~~~~~~~~~~~~~~~~~~~~~ BCHackTool ~~~~~~~~~~~~~~~~~~~~~~~~~" 
	...
	echo " [13] ✔ RED_HAWK              [14] ✔ Ghost" 
        ...
        case "$option" in 
            1)
            if [[ -d hammer-bot ]] ; then
                ok
            else
                clear
                cat banners/bcbanner  
                echo -e $red "[0] hammer İndiriliyor "
               #!/bin/bash
	...
	echo " [13] ✔ RED_HAWK              [14] ✔ Ghost" 
        ...
        case "$option" in 
            ...
            if [[ -d inshackle-bot ]] ; then
                ...
                git clone https://github.com/cyberkallan/inshackle-bot > /dev/null 2>&1#!/bin/bash
...
echo "  ~~~~~~~~~~~~~~~~~~~~~ BCHackTool ~~~~~~~~~~~~~~~~~~~~~~~~~" 
        echo ""
        echo " [1] ✔ hammer              [2] ✔ Ripper" 
        echo " [3] ✔ Xerxes               [4] ✔ UserRecon" 
        echo " [5] ✔ Instashell             [6] ✔ Cupp" 
        echo " [7] ✔ SpamWa                 [8] ✔ Ip-Tracer" 
        echo " [9] ✔ OSIF                   [10] ✔ CamHackers" 
        echo " [11] ✔ TheFatRat             [12] ✔ RequiredChan" 
	echo " [13] ✔ RED_HAWK              [14] ✔ Ghost" 
        ...
        case "$option" in 
            ...
            if [[ -d Ripper ]] ; then
                ...
                clear
                cat banners/bcbanner
                echo -e $red "[0] Ripper İndiriliyor "
                git clone https://github.com/palahsu/DDoS-Ripper > /dev/null 2>&1
      cd DDoS-Ripper
      python3 DRipper.py
            ...
            3)
             if [[ -d Xerxes ]] ; then
                ...
                clear
                cat banners/bcbanner  
                echo -e $red "[0] Xerxes İndiriliyor "
                git clone https://github.com/CyberXCodder/XerXes >  /dev/null 2>&1
                spinlong
                echo -e $red "[2] Xerxes Kuruldu "
                sleep 3
            fi
            clear
